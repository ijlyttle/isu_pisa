...
The PISA dataset contains dozens of household factors; we wanted a way to make our data-exploration more efficient. Moreover, we wanted a way that we could make explorations independent of each other, as during the course of the invesigation our team was in three cities over two hemispheres.

To make our exploration easier, we developed a "Shiny" app. 
