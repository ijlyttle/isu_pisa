...
a6 <- summaryBy(data=student2012, PV1MATH + ESCS ~ ST15Q01+name, FUN=mean, rm.na=T)
a7 <- summaryBy(data=student2012, PV1MATH + ESCS ~ ST19Q01+name, FUN=mean, rm.na=T)
...
a8$name <- factor(a8$name, a8$name[order(a8$Math[ind])])
qplot(name, Math, col=Job.Status, data = a8) + coord_flip() + facet_wrap(~Parent)
```
