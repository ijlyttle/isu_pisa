...
#student2012.sub.map <- merge(student2012.sub.math, world.polys, all.y=TRUE)
#qplot(X1, X2, order=order, group=group, data=student2012.sub.map, geom="polygon", fill=math, colour=I("grey70")) + 
  #coord_map(xlim=c(-195, 185), ylim=c(-150, 95)) + # Having trouble getting coord_map to not cut off polygons weirdly
#  new_theme_empty + theme(legend.position="none")
```
